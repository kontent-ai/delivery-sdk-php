...
- `ContentLinkUrlResolverInterface` (optional) - to change the way how the links in rich text elements are resolved. See [Resolving links to content items
](https://github.com/Kentico/delivery-sdk-php/wiki/Resolving-links-to-content-items).
