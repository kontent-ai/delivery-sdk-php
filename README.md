...
[![Build Status](https://travis-ci.com/Kentico/kontent-delivery-sdk-php.svg?branch=master)](https://travis-ci.com/Kentico/kontent-delivery-sdk-php)
...
{
    "require": {
        "kentico/kontent-delivery-sdk-php": "^3.0.0"
    }
}
```
