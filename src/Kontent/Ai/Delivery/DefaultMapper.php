...
use Kontent\Ai\Delivery\Models\Items\ContentItemSystem;
...
class DefaultMapper implements TypeMapperInterface, PropertyMapperInterface, ValueConverterInterface, ContentLinkUrlResolverInterface, InlineLinkedItemsResolverInterface
{
     ...
     * @var string
     */
    protected $ci = \Kontent\Ai\Delivery\Models\Items\ContentItem::class;
    ...
    public function getTypeClass($typeName)
    {
        switch ($typeName) {
            case 'asset':
                $type = \Kontent\Ai\Delivery\Models\Items\Asset::class;
                break;
            case 'taxonomy':
                $type = \Kontent\Ai\Delivery\Models\Items\TaxonomyTerm::class;
                break;
            case 'multiple_choice':
                $type = \Kontent\Ai\Delivery\Models\Items\MultipleChoiceOption::class;
                break;
            case null:
                $type = null;
                break;
